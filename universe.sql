...
CREATE TABLE public.moon (
    ...
    distance_from_planet_km numeric(4,1) NOT NULL
);
...
INSERT INTO public.moon VALUES (13, 'Enceladus', NULL, 5, 0.0);
...
INSERT INTO public.planet VALUES (2, 'Venus', false, true, 2, 2, 0);
...
INSERT INTO public.planet_types VALUES (3, 'Eccentric Jupiter', ' A gas giant that orbits its star in an eccentric orbit');
INSERT INTO public.planet_types VALUES (4, 'Exoplanet', 'A planet that orbits the Sun, but a different star, a stellar remnant or a brown dwarf');
INSERT INTO public.planet_types VALUES (5, 'Extragalactic planet', 'An exoplanet outside the milky way');
INSERT INTO public.planet_types VALUES (6, 'Goldilocks planet', 'A planet with an orbit that falls within the stars habitable zone');
